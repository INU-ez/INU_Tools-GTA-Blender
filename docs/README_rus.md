...
- **Редактор тайм-циклов** (`timecyc.dat`) — превью погоды и часа как настоящий свет, правка срезов, туман и PostFX.
- **Запекание текстур и прилайта** — AO / Diffuse / Shadow / Alpha, тень-декали, прилайт от всех ламп + HDRI, LightMap.
...
- SA-only фичи (Night vcols, Pipeline-чанк, UV-аним, multi-mesh LOD, SunGlare) при записи в III/VC отбрасываются с предупреждением.
...
**Автор:** INU (Discord `1.n.u` · [сервер](https://discord.gg/sqtGAVTGdy)) · зеркало анимаций — **yeezyk**
